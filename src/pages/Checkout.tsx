...
const Checkout = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const paymentUrl = result.payment_url || result.data?.payment_url || result.checkout_url || result.url;
    ...
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        <div className="animate-fade-in">
          <h2 className="text-3xl font-bold text-purple-900 mb-4">No items to checkout</h2>
          <p className="text-gray-600 mb-8">Add some books to your cart first.</p>
          <Button 
            onClick={() => navigate('/')} 
